...
A statistical formulation \citep{young2002htk} follows given that each discretised output word in the audio speech signal is represented as a vector sequence of observations defined in the set $$\mathbf{O}$$. Therefore
